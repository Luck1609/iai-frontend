    ...
    <div className="w-full bg-mechanic bg-cover h-96 flex justify-center items-center mt-16">
      <FormProvider { ...methods }>
        <form className="bg-transparent text-white text-center w-[400px]">
          ...
          <label className="block my-5">Subscribe to receive news and updates</label>
          
          <div className="relative">
            <input type="text" className="bg-default-blue w-full text-white p-5 rounded " placeholder="Enter your email" />
            <FormBtn 
